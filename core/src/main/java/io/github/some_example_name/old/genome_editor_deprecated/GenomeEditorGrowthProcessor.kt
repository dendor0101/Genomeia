...
//    val simulationFullReplay = mutableListOf<FullReplayStructure>()
    var currentGenome = genomeManager.genomeForEditor
    var maxCellId = 0
...
//            )
        ...
        for (i in 0..currentFullReplay.cellLastId) {
            val xGrid = currentFullReplay.x[i].toInt()
            val yGrid = currentFullReplay.y[i].toInt()
...
*/
//TODO не использовать эти константы
//TODO не использовать эти константы
